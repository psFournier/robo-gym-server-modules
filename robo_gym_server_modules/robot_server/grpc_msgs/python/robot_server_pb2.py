...
_BYTEIMAGE = _descriptor.Descriptor(
  name='ByteImage',
  full_name='robot_server.ByteImage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='image', full_name='robot_server.ByteImage.image', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='width', full_name='robot_server.ByteImage.width', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='height', full_name='robot_server.ByteImage.height', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='channel', full_name='robot_server.ByteImage.channel', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='success', full_name='robot_server.ByteImage.success', index=4,
      number=5, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['ByteImage'] = _BYTEIMAGE
...
ByteImage = _reflection.GeneratedProtocolMessageType('ByteImage', (_message.Message,), {
  'DESCRIPTOR' : _BYTEIMAGE,
  '__module__' : 'robot_server_pb2'
  # @@protoc_insertion_point(class_scope:robot_server.ByteImage)
  })
_sym_db.RegisterMessage(ByteImage)
